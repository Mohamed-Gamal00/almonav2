        ...
        <div class="col-md-10">
          <div class="row align-items-center justify-content-between mb-2">
            <div class="col-lg-5 fw-bold align-middle text-center text-lg-end">
              ...
              >
                <span style="color: #ffcc66">المني للتسويق</span> رائدين في مجال
                التقنيات الحديثة والتسويق الإلكتروني
              </h2>
              ...
              <a
                href="#contact_us"
                style="background-color: #323232; color: #ffcc66"
                class="btn fw-bold mb-4 rounded-pill border-2 py-3 px-5"
                >تواصل معنا</a
              >
            </div>
            <div class="col-lg-6 text-center mt-sm-4 text-lg-start">
              <img class="img-fluid" src="@/assets/almonablack.png" alt="img" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-10">
          <div class="row">
            <div class="col-md-3">
              ...
              <p class="fs-6 fw-bold"><strong>مشاهدات</strong></p>
            </div>
            <div class="col-md-3">
              <Vue3autocounter
                class="counter"
    ...
    >
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-10">
            <span class="ms-3"
              ><img src="@/assets/almona.png" width="40" alt="" />
            </span>
          ...
          <div class="col-md-10">
            ...
            >
              ...
              <div class="col-md-5 ps-md-0" style="box-sizing: content-box">
                <p class="fs-4 fw-bold">المني للتسويق</p>
                <ul class="p-0">
      ...
      <div class="container">
        ...
        <div class="row mt-3 d-flex justify-content-center">
          <div class="col-md-10">
            ...
            <!-- <div class="row d-flex justify-content-center">
              <div
                class="col-md-3 m-1 d-flex justify-content-center"
                v-for="service in services"
                :key="service"
              >
                <a class="marketserv-btn service-btn" role="button">
                  <span class="market-button-name">{{ service.name }}</span>
                  <span class="market-button-desc">{{ service.desc }}</span>
                </a>
              </div>
            </div> -->
          </div>
              ...
              >
                <a
                  ...
                  style="
                    ...
                    height: 43px;
                  "
                  class="btn border-0 text-center fw-bold rounded-pill py-2 px-4"
                  >المزيد</a
                >
              </router-link>
            </div>
